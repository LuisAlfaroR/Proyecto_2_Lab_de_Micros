...
void display(void)
{
   ...
   glRasterPos2i(567, 600);
   printString("BIENVENIDO A MICRONOID");
   glRasterPos2i(483, 480);
   printString("LAB DE ESTRUCTURA DE MICROPROCESADORES");
   glRasterPos2i(625, 360);
   printString("II SEMESTRE");
   glRasterPos2i(532, 240);
   printString("INGRESE EL NOMBRE DEL JUGADOR");
